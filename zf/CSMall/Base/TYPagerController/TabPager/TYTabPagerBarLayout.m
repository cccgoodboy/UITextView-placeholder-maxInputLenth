...
- (void)configurePropertys {
    ...
    _selectedTextColor = [UIColor colorWithRed:58/255.0 green:194/255.0 blue:166/255.0 alpha:1];
...
- (void)setUnderLineFrameWithIndex:(NSInteger)index animated:(BOOL)animated
{
    ...
    CGFloat progressHorEdging = _progressWidth > 0 ? cellFrame.size.width: _progressHorEdging;
