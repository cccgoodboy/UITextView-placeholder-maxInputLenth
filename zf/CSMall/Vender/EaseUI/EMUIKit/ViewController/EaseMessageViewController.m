...
- (void)viewDidLoad {
    ...
    self.chatToolbar = [[EaseChatToolbar alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - chatbarHeight, [UIScreen mainScreen].bounds.size.width, chatbarHeight) type:barType];
