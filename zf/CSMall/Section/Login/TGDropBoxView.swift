...
let TGDropBoxDefaultColor: UIColor = UIColor.black
...
class TGDropBoxView: UIView {
    ...
    override func layoutSubviews() {
        ...
        self.boxTitle.frame.size = CGSize(width: self.frame.size.width-20, height: self.frame.size.height)
        ...
        let listReact:CGRect = self.convert(self.frame, to: self.parentVC.view)
        self.listTableView.frame.origin = CGPoint(x: listReact.origin.x, y: listReact.origin.y-listReact.size.height)
